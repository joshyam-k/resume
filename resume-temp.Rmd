...
- <i class="fa fa-envelope"></i> joshuayamamoto5@gmail.com
- <i class="fa fa-github"></i> [github.com/joshyam-k](https://github.com/joshyam-k)
- <i class="fa fa-twitter"></i> [twitter.com/joshyam_](httmps://twitter.com/joshyam_)
...
- Highly skilled in R, git, LaTeX

- Experience with Python, ArcGIS, SQL
...
and the source can be found in [this repository](https://github.com/joshyam-k/resume)
